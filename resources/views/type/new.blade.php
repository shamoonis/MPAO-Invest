...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <form id="storeTypes" enctype="multipart/form-data">
            <div class="form-group">
                ...
                {{ csrf_field() }}
                <small id="emailHelp" class="form-text text-muted">Enter the investment type name above.</small>
            </div>
...
//store funds
$("#storeTypes").on("submit",function(e){
        e.preventDefault();
...
//get funds
$("#result").empty();
var sPath = "http://localhost:8000/types/view";
$result = "";
